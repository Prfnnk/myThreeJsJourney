...
/**
 * Lights -> not all of them support shadows. Only DirectionalLight, SpotLight and PointLight
 */
// Ambient light
...
sphere.castShadow = true; // create shadow on a plane below

const plane = new THREE.Mesh(new THREE.PlaneGeometry(5, 5), new THREE.MeshStandardMaterial({ map: bakedShadow }));
plane.rotation.x = -Math.PI * 0.5;
plane.position.y = -0.5;

plane.receiveShadow = true; // receive shadow from the sphere
